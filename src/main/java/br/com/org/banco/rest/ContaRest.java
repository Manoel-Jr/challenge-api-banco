...
import br.com.org.banco.dto.ContaDTO;
...
public class ContaRest {
	...
	public ResponseEntity<Conta> pesquisarContaPorAgenciaNumeroConta(@PathVariable String agencia,
			@PathVariable String numeroConta) {
		return new ResponseEntity<>(contaService.buscarPorAgenciaNumroConta(agencia, numeroConta), HttpStatus.OK);
	}
	...
	public ResponseEntity<String> transferencia(@RequestBody TransferenciaDTO dto) {
		...
		Conta contaDestino = contaService.buscarPorAgenciaNumroConta(dto.getAgenciaDestino(),
	...
	public ResponseEntity<String> consultarSaldo(@RequestBody ContaDTO dto) {
		Conta conta = contaService.buscarPorAgenciaNumroConta(dto.getAgencia(), dto.getNumeroConta());
		contaService.consultarSaldo(conta.getAgencia(), conta.getNumeroConta());
		return ResponseEntity.status(HttpStatus.ACCEPTED).body("Consulta Realizada com Sucesso!");
	}
}
